---
name: avito
description: Чтение объявлений, фильтров, категорий, локаций и отзывов продавцов на Avito через локальный CLI `avito`. Используй только если пользователь прямо упоминает Авито / Avito или даёт ссылку на avito.ru.
